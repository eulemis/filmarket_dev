          ...
          >
            ...
            <v-container >
                <v-layout row wrap >
                    ...
                    <v-col cols="12" sm="6" md="4">
                        <v-text-field  :append-icon="show ? 'mdi-eye' : 'mdi-eye-off'"   :type="show ? 'text' : 'password'" @keyup="validarPassword()" label="Password Confirmation" placeholder="Password Confirmation" outlined dense  :rules="[(usersForm.password === usersForm.password_confirmation) || 'confirmación Incorrecta ']" v-model="usersForm.password_confirmation"  @click:append="show = !show">
                        </v-text-field>
                    </v-col>
                </v-layout>
            </v-container>
...
export default class Users extends Vue {
    ...
    snackbar = false
    textmsj     = '' 
    sectiontitle = 'Actualizar Contraseña de Usuario'
    ...
    validarPassword(){
        if (this.usersForm.password_confirmation == this.usersForm.password ) {
